    ...
    describe('functional requirements', () => {
        ...
        it.optional('double-sided direct cryptography', () => {
            for (let i = 2; i < 200; i += 1) {
                ...
                assert.equal(directMachine.decrypt(encrypted, testKey), testStr, 'testStr = ' + testStr + ', testKey = ' + testKey + ', encrypted: ' + encrypted);
            }
        });
        ...
        it.optional('double-sided reverse cryptography 2', () => {
            for (let i = 2; i < 200; i += 1) {
                ...
                assert.equal(reverseMachine.decrypt(reversedEncrypted, testKey), testStr, 'testStr = ' + testStr + ', testKey = ' + testKey + ', encrypted: ' + encrypted);
            }
        });
    });
